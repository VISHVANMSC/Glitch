  ...
  teams: [
    {
      ...
      barcodeUrl: 'data:image/svg+xml;base64,',
      result: 'FIRST_PRIZE',
      createdAt: new Date(),
      updatedAt: new Date(),
    },
...
export const dataService = {
  ...
  async checkUniqueMembers(
    ...
    // Allow previously registered emails and phone numbers to be accepted for registration
    return { success: true };
  },
